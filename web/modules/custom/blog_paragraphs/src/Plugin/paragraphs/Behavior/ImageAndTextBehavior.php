...
class ImageAndTextBehavior extends ParagraphsBehaviorBase {
  ...
  public function buildBehaviorForm(ParagraphInterface $paragraph, array &$form, FormStateInterface $form_state) {
    ...
    $form['image_position'] = [
      ...
      '#default' => $paragraph->getBehaviorSetting($this->getPluginId(), 'image_position', 'left'),
    ];
    ...
    $form['image_size'] = [
      ...
      '#default_settings' => $paragraph->getBehaviorSetting($this->getPluginId(), 'image_size', '4_12'),
    ];
    return $form;
  }
